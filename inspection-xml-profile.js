...
export function formatInspectionNumber(value, options = {}) {
...
function geometryNumber(value) {
  return formatInspectionNumber(value, { precision: 3, minDecimals: 1 });
}

function angleNumber(value) {
  return formatInspectionNumber(value ?? 0, { precision: 5, minDecimals: 1 });
}
...
export function isStructuredInspectionXml(xmlText = '') {
...
export function exportInspectionXml(model, options = {}) {
